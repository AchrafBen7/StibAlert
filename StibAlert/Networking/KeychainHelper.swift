...
enum KeychainHelper {
    private static let service = "com.stibalert.auth"
    private static let account = "jwt"
    private static let refreshAccount = "refresh_token"
    private static let anonymousDeviceAccount = "anonymous_device_id"
    ...
    static func anonymousDeviceId() -> String {
        ...
        saveString(generated, account: anonymousDeviceAccount)
        return generated
    }
